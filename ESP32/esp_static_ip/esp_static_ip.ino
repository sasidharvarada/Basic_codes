...
#include <WiFi.h>                  // for esp32 
  ...
  IPAddress local_IP(10, 2, 131, 150);    // Static IP address
  IPAddress gateway(10, 2, 128, 1);      // Gateway IP address
  IPAddress subnet(255, 255, 240, 0);     // Subnet mask
  IPAddress primaryDNS(8, 8, 8, 8);      // Primary DNS server (e.g., Google DNS)
  IPAddress secondaryDNS(8, 8, 4, 4);    // Secondary DNS server (e.g., Google DNS)
...
void setup() {
  ...
  // Configure static IP address with primary and secondary DNS
